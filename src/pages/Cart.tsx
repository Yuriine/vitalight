import { ArrowLeft, ChevronLeft, Minus, Plus, Trash } from "lucide-react";
...
const Cart: React.FC = () => {
  ...
  return (
    <div
      ...
      className="min-h-screen py-10 bg-cover  bg-no-repeat relative bg-primary"
    >
      <button
        className="btn btn-ghost rounded-lg mx-4"
        onClick={() => navigate("/")}
        type="button"
      >
      ...
      <div className=" z-10 p-4">
        {/* Header llamativo */}
        <div className="flex flex-col md:justify-center items-center gap-3 mb-8">
        ...
        <div className="flex flex-col gap-4 md:w-1/2 mx-auto justify-center items-start"> {/* Formulario */}
          <div className="card border border-dashed border-base-300  bg-base-100 w-full">
          ...
          {/* Carrito */}
          <div className="card border w-full  border-dashed border-base-300  bg-base-100 mb-8">
            <div className="card-body p-4 md:p-8">

              <ul className="flex flex-col md:gap-8 ">
                {items.map(item => (
                  <li key={item.id} className="flex flex-col md:justify-between  md:flex-row gap-4 md:items-center bg-base-200/80 rounded-xl   transition ">
              ...
              {items.length > 0 && (
                <div className="flex justify-between items-center text-lg font-bold md:divider md:mt-10">
                  <span>Total:</span>
